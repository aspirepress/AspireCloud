...
beforeEach(function () {
    ...
    Theme::create([
        ...
        'version' => '1.2.1',
        'download_link' => 'https://downloads.wordpress.org/theme/my-theme-1.2.3.zip',
        'requires_php' => '5.6',
    ...
    Theme::create([
        ...
        'download_link' => 'https://downloads.wordpress.org/theme/my-theme2-6.6.6.zip',
        'requires_php' => '5.6',
        'last_updated' => '2021-01-11 12:00:00',
        'creation_time' => '2021-01-01 12:00:00',
        ...
        ->assertJson([
            'themes' => [
                'my-theme' => [
                    ...
                    'theme' => 'my-theme',
                    'new_version' => '1.2.1',
                    'url' => 'https://api.aspiredev.org/download/theme/my-theme-1.2.3.zip',
                    'package' => 'https://api.aspiredev.org/download/theme/my-theme-1.2.3.zip',
                    'requires' => null,
                    'requires_php' => '5.6',
                ],
            ],
            'no_update' => [
                'my-theme2' => [
                    ...
                    'theme' => 'my-theme2',
                    'new_version' => '2.9',
                    'url' => 'https://api.aspiredev.org/download/theme/my-theme2-6.6.6.zip',
                    'package' => 'https://api.aspiredev.org/download/theme/my-theme2-6.6.6.zip',
                    'requires' => null,
                    'requires_php' => '5.6',
                ],
            ],
